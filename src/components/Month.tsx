      ...
      <Radio.Group onChange={onChangeType} value={props.value.cronEvery}>
        <Space direction="vertical">
          ...
          <Row align="middle">
            ...
            <Col>
              <span className="optionLabel">{t('Month.interval.0')}</span>
              <InputNumber
              ...
              />
              <span className="optionLabel">{t('Month.interval.1')}</span>
              <InputNumber
              ...
              />
              <span className="optionLabel">{t('Month.interval.2')}</span>
            </Col>
          </Row>
          <Row align="middle">
            <Col>
            ...
            <Col>
              <span className="optionLabel">{t('Month.specific')}</span>
              <Select
                mode="multiple"
                allowClear
                style={{ width: 260 }}
          ...
          <Row align="middle">
            ...
            <Col>
              <span className="optionLabel">{t('Month.cycle.0')}</span>
              <InputNumber
              ...
              />
              <span className="optionLabel">{t('Month.cycle.1')}</span>
              <InputNumber
              ...
              />
              <span className="optionLabel">{t('Month.cycle.2')}</span>
            </Col>
          </Row>
        </Space>
      </Radio.Group>
